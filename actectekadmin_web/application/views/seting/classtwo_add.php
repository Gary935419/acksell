    ...
    <div class="layui-row">
        <form method="post" class="layui-form" action="" name="basic_validate" id="tab">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline" style="width: 60%;">
					<input type="text" id="classtname" name="classtname" lay-verify="classtname"
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline" style="width: 60%;">
					...
					<div class="layui-upload-list">
						<input type="hidden" name="classtimg" id="classtimg" lay-verify="classtimg" autocomplete="off"
							   class="layui-input">
						<img class="layui-upload-img" style="width: 100px;height: 100px;display: none;" id="classtimgimg" name="classtimgimg">
						<p id="demoText"></p>
					</div>
				</div>
			</div>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline" style="width: 60%;">
					<input type="text" id="classdatasheet" name="classdatasheet" lay-verify="classdatasheet"
						   autocomplete="off" class="layui-input">
				</div>
			</div>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline" style="width: 60%;">
					<input type="text" id="classdescription" name="classdescription" lay-verify="classdescription"
						   autocomplete="off" class="layui-input">
				</div>
			</div>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline" style="width: 60%;">
					<input type="text" id="classbuynow" name="classbuynow" lay-verify="classbuynow"
						   autocomplete="off" class="layui-input">
				</div>
			</div>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline" style="width: 60%;">
					<input type="text" id="classlearnmore" name="classlearnmore" lay-verify="classlearnmore"
						   autocomplete="off" class="layui-input">
				</div>
			</div>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline" style="width: 60%;margin-top: 10px">
					<input type="text" readonly id="classbreakout" name="classbreakout"
						   autocomplete="off" class="layui-input">
				</div>
			</div>
