        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="layui-card-body ">
                    <form class="layui-form layui-col-space5" method="get" action="<?= RUN, '/seting/faq_list' ?>">
                        <div class="layui-inline layui-show-xs-block">
                            <input type="text" name="question" id="question" value="<?php echo $question ?>"
                                   placeholder="问题" autocomplete="off" class="layui-input">
                        </div>
                        <div class="layui-inline layui-show-xs-block">
                ...
                <button class="layui-btn layui-card-header" style="float: right;margin-top: -40px;margin-right: 20px;"
                        onclick="xadmin.open('添加','<?= RUN . '/seting/faq_add' ?>',900,500)"><i
                                ...
                                <tr id="p<?= $once['id'] ?>" sid="<?= $once['id'] ?>">
                                    ...
                                    <td class="td-manage">
										<button class="layui-btn layui-btn-danger"
												onclick="faq_delete('<?= $once['id'] ?>')"><i class="layui-icon">&#xe640;</i>删除
										</button>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
