        ...
        <form method="post" class="layui-form" action="" name="basic_validate" id="tab">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline" style="width: 60%;">
					<input type="text" id="classname" name="classname" lay-verify="classname"
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline" style="width: 60%;">
					...
					<div class="layui-upload-list">
						<input type="hidden" name="classimg" id="classimg" lay-verify="classimg" autocomplete="off"
							   class="layui-input">
						<img class="layui-upload-img" style="width: 100px;height: 100px;display: none;" id="classimgimg" name="classimgimg">
						<p id="demoText"></p>
					</div>
				</div>
			</div>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline" style="width: 60%;">
					<input type="text" id="classtitle" name="classtitle" lay-verify="classtitle"
						   autocomplete="off" class="layui-input">
				</div>
			</div>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline" style="width: 60%;">
						<textarea id="classcontent" name="classcontent" class="layui-textarea"
								  lay-verify="classcontent"></textarea>
				</div>
			</div>
